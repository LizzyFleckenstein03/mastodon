...
class Rack::Attack
  ...
  throttle('throttle_authenticated_api', limit: 1000000, period: 5.minutes) do |req|
    req.authenticated_user_id if req.api_request?
  end

  throttle('throttle_per_token_api', limit: 1000000, period: 5.minutes) do |req|
  ...
  throttle('throttle_api_media', limit: 1000000, period: 30.minutes) do |req|
    req.authenticated_user_id if req.post? && req.path.match?(%r{\A/api/v\d+/media\z}i)
  end

  throttle('throttle_media_proxy', limit: 1000000, period: 10.minutes) do |req|
  ...
  throttle('throttle_authenticated_paging', limit: 1000000, period: 15.minutes) do |req|
  ...
  throttle('throttle_api_delete', limit: 1000000, period: 30.minutes) do |req|
